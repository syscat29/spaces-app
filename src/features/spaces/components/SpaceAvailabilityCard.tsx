    ...
    <div className='sticky top-4'>
      <Card className='w-90 px-6 py-8 flex flex-col'>
        <div className='mb-6 text-center space-y-2 text-[#888]'>
          ...
          <p>
            <span className='text-3xl font-bold text-white'>${space.price}</span>
            <span>/hr</span>
          </p>
        </div>
        <button className='border-none bg-background text-foreground px-4 py-2 uppercase text-sm cursor-pointer font-semibold transition-colors duration-200 tracking-wide hover:bg-[#ccc]'>
          check availability
        </button>
